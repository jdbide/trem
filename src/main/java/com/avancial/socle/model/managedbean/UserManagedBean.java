...
public class UserManagedBean extends AManageBean {
   ...
   public String add() throws ASocleException {
      ...
      try {
         dao.save(user);
         FacesContext.getCurrentInstance().addMessage(SOCLE_constants.PAGE_ID_MESSAGES.toString(), new FacesMessage(FacesMessage.SEVERITY_INFO, "message", "Utilisateur Cr�er."));
