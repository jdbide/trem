...
public class User {
    ...
    Integer   idUserCreateUser;
    
    Integer idUserUpdateUser;
    ...
    public Integer getUserCreateUser() {
        return this.idUserCreateUser;
    }

    public void setUserCreateUser(Integer idUserCreateUser) {
        this.idUserCreateUser = idUserCreateUser;
    }

    public Integer getUserUpdateUser() {
        return this.idUserUpdateUser;
    }

    public void setUserUpdateUser(Integer idUserUpdateUser) {
        this.idUserUpdateUser = idUserUpdateUser;
    }
