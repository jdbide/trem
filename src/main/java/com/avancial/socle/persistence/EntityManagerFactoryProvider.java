...
/**
 * EntityManagerFactoryProvider singleton qui gère l'unicité des entityManagerFactory
 * => une EntityManagerFactory par persistanceUnitName
 * 
...
public class EntityManagerFactoryProvider {
    ...
    * 
    * <p>Si aucune entityManagerFactory n'est enregistré avec le même persistUnitName, la méthode
    * s'occupera de la création de celui la</p></br>
    * 
    * <p>La méthode utilise la configuration déclaré dans la persistance-unit (Persistance.xml)</p>
    * 
    * @param persistUnitName (String) le libelle de persistance-unit name
    ...
    * s'occupera de la création de celui la</p></br>
    * 
    * <p>La méthode utilise la configuration déclaré dans la persistance-unit (Persistance.xml) + persistUnitConfig</p>
    * 
    * @param persistUnitName (String) le libelle de persistance-unit name
    * @param persistUnitConfig (Map<String, String>) la configuration de la persistance-unit
    * @return EntityManagerFactory
    */
    ...
    * 
    * <p>L'entityManagerFactory n'existera plus aprés l'appel à cette methode</p>
    * 
