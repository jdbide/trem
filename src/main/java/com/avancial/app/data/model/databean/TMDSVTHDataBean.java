...
@Entity
@Table(name = "VMDSVTH0", schema = "F$MDRP1")
@Immutable
public class TMDSVTHDataBean {
   ...
   public String getSVTH_TRCH_COD_CIE() {
      return SVTH_TRCH_COD_CIE;
   }
   /**
    * @param sVTH_TRCH_COD_CIE the sVTH_TRCH_COD_CIE to set
    */
   public void setSVTH_TRCH_COD_CIE(String sVTH_TRCH_COD_CIE) {
      SVTH_TRCH_COD_CIE = sVTH_TRCH_COD_CIE;
   }
   /**
    * @return the sVTH_TRCH_NUM_TRA1
    */
   public String getSVTH_TRCH_NUM_TRA1() {
      return SVTH_TRCH_NUM_TRA1;
   }
   /**
    * @param sVTH_TRCH_NUM_TRA1 the sVTH_TRCH_NUM_TRA1 to set
    */
   public void setSVTH_TRCH_NUM_TRA1(String sVTH_TRCH_NUM_TRA1) {
      SVTH_TRCH_NUM_TRA1 = sVTH_TRCH_NUM_TRA1;
   }
   /**
    * @return the sVTH_TRCH_IND_FER
    */
   public String getSVTH_TRCH_IND_FER() {
      return SVTH_TRCH_IND_FER;
   }
   /**
    * @param sVTH_TRCH_IND_FER the sVTH_TRCH_IND_FER to set
    */
   public void setSVTH_TRCH_IND_FER(String sVTH_TRCH_IND_FER) {
      SVTH_TRCH_IND_FER = sVTH_TRCH_IND_FER;
   }
   /**
    * @return the sVTH_TRCH_NUM
    */
   public Long getSVTH_TRCH_NUM() {
      return SVTH_TRCH_NUM;
   }
   /**
    * @param sVTH_TRCH_NUM the sVTH_TRCH_NUM to set
    */
   public void setSVTH_TRCH_NUM(Long sVTH_TRCH_NUM) {
      SVTH_TRCH_NUM = sVTH_TRCH_NUM;
   }
   /**
    * @return the sVTH_LIBS_SERV_COD
    */
   public String getSVTH_LIBS_SERV_COD() {
      return SVTH_LIBS_SERV_COD;
   }
   /**
    * @param sVTH_LIBS_SERV_COD the sVTH_LIBS_SERV_COD to set
    */
   public void setSVTH_LIBS_SERV_COD(String sVTH_LIBS_SERV_COD) {
      SVTH_LIBS_SERV_COD = sVTH_LIBS_SERV_COD;
   }
   /**
    * @return the sVTH_NUM
    */
   ...
   /**
    * @param sVTH_NUM the sVTH_NUM to set
    */
   ...
   public String getSVTH_COD_ORIGINE() {
      return SVTH_COD_ORIGINE;
   }
   /**
    * @param sVTH_COD_ORIGINE the sVTH_COD_ORIGINE to set
    */
   public void setSVTH_COD_ORIGINE(String sVTH_COD_ORIGINE) {
      SVTH_COD_ORIGINE = sVTH_COD_ORIGINE;
   }
   /**
    * @return the sVTH_INPT_RR_D
    */
   public String getSVTH_INPT_RR_D() {
      return SVTH_INPT_RR_D;
   }
   /**
    * @param sVTH_INPT_RR_D the sVTH_INPT_RR_D to set
    */
   public void setSVTH_INPT_RR_D(String sVTH_INPT_RR_D) {
      SVTH_INPT_RR_D = sVTH_INPT_RR_D;
   }
   /**
    * @return the sVTH_INPT_RR_F
    */
   public String getSVTH_INPT_RR_F() {
      return SVTH_INPT_RR_F;
   }
   /**
    * @param sVTH_INPT_RR_F the sVTH_INPT_RR_F to set
    */
   public void setSVTH_INPT_RR_F(String sVTH_INPT_RR_F) {
      SVTH_INPT_RR_F = sVTH_INPT_RR_F;
   }
   /**
   ...
   /**
    * @param sVTH_REGI the sVTH_REGI to set
    */
   ...
   public String getSVTH_IND_SPTH() {
      return SVTH_IND_SPTH;
   }
   /**
    * @param sVTH_IND_SPTH the sVTH_IND_SPTH to set
    */
   public void setSVTH_IND_SPTH(String sVTH_IND_SPTH) {
      SVTH_IND_SPTH = sVTH_IND_SPTH;
   }
   /**
    * @return the sVTH_TYP_CLAS
    */
   public String getSVTH_TYP_CLAS() {
      return SVTH_TYP_CLAS;
   }
   /**
    * @param sVTH_TYP_CLAS the sVTH_TYP_CLAS to set
    */
   public void setSVTH_TYP_CLAS(String sVTH_TYP_CLAS) {
      SVTH_TYP_CLAS = sVTH_TYP_CLAS;
   }
   /**
   ...
   /**
    * @param sVTH_USER the sVTH_USER to set
    */
   ...
   /**
    * @param sVTH_DHDO the sVTH_DHDO to set
    */
