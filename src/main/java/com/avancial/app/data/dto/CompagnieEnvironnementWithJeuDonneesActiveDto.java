...
public class CompagnieEnvironnementWithJeuDonneesActiveDto {
   ...
   private int     idJeuDonneesActive;
   private Date    dateCreateJeuDonneesActive;
   private Date    dateLastUpdateJeuDonneesActive;
   private int     idUtilisateurCreateJeuDonneesActive;
   private int     idUtilisateurLastUpdateJeuDonneesActive;
   private Date    dateDebutPeriodeJeuDonneesActive;
   private EStatus statusJeuDonneesActive;

   /**
    * 
    */
   public CompagnieEnvironnementWithJeuDonneesActiveDto() {
   ...
   /**
    * @return the actifCompagnieEnvironnement
    */
   public byte getActifCompagnieEnvironnement() {
      return actifCompagnieEnvironnement;
   }
   ...
   /**
    * @return the nomTechniqueCompagnie
    */
   public String getNomTechniqueCompagnie() {
      return nomTechniqueCompagnie;
   }
   ...
   /**
    * @return the nomTechniqueEnvironnement
    */
   public String getNomTechniqueEnvironnement() {
      return nomTechniqueEnvironnement;
   }
   ...
   /**
    * @return the idJeuDonneesActive
    */
   public int getIdJeuDonneesActive() {
      return idJeuDonneesActive;
   }
   ...
   /**
    * @return the dateCreateJeuDonneesActive
    */
   public Date getDateCreateJeuDonneesActive() {
      return dateCreateJeuDonneesActive;
   }
   ...
   /**
    * @return the dateLastUpdateJeuDonneesActive
    */
   public Date getDateLastUpdateJeuDonneesActive() {
      return dateLastUpdateJeuDonneesActive;
   }
   ...
   /**
    * @return the idUtilisateurCreateJeuDonneesActive
    */
   public int getIdUtilisateurCreateJeuDonneesActive() {
      return idUtilisateurCreateJeuDonneesActive;
   }
   ...
   /**
    * @return the idUtilisateurLastUpdateJeuDonneesActive
    */
   public int getIdUtilisateurLastUpdateJeuDonneesActive() {
      return idUtilisateurLastUpdateJeuDonneesActive;
   }
   ...
   /**
    * @return the dateDebutPeriodeJeuDonneesActive
    */
   public Date getDateDebutPeriodeJeuDonneesActive() {
      return dateDebutPeriodeJeuDonneesActive;
   }
   ...
   /**
    * @return the statusJeuDonneesActive
    */
   public EStatus getStatusJeuDonneesActive() {
      return statusJeuDonneesActive;
   }
