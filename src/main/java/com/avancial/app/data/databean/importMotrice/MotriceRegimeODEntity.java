...
@NamedQueries({@NamedQuery(name = "MotriceRegimeOD.getAll", query = "SELECT t FROM MotriceRegimeODEntity t"),
        @NamedQuery(name = "MotriceRegimeOD.getById", query = "SELECT t FROM MotriceRegimeODEntity t WHERE t.idMotriceRegimeOD = :idMotriceRegimeOD"),
        ...
        @NamedQuery(name = "MotriceRegimeODEntity.getRefOdByIdTrainTranche",
                query = "SELECT od.motriceRefODEntity FROM MotriceRegimeODEntity od join od.motriceRegime as regime join regime.motriceTrainTranche as tt where tt.idMotriceTrainTranche = :idMotriceTrainTranche")})
