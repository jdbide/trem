...
public class ImportTMDCDEMEntity {
   ...
   /**
    * @param cDEM_TRA1_COD_CIE
    *           the cDEM_TRA1_COD_CIE to set
    */
   ...
   /**
    * @param cDEM_TRA1_NUM_TRA1
    *           the cDEM_TRA1_NUM_TRA1 to set
    */
   ...
   /**
    * @param cDEM_TRA1_IND_FER
    *           the cDEM_TRA1_IND_FER to set
    */
    ...
    */
   public String getCDEM_NUM_CONDITION() {
      return this.CDEM_NUM_CONDITION;
   }

   /**
    * @param cDEM_NUM_CONDITION
    *           the cDEM_NUM_CONDITION to set
    */
   public void setCDEM_NUM_CONDITION(String cDEM_NUM_CONDITION) {
   ...
   /**
    * @param cDEM_LIBS_TYCO_COD
    *           the cDEM_LIBS_TYCO_COD to set
    */
    ...
    */
   public String getCDEM_DHDO() {
      return this.CDEM_DHDO;
   }

   /**
    * @param cDEM_DHDO
    *           the cDEM_DHDO to set
    */
   public void setCDEM_DHDO(String cDEM_DHDO) {
