...
@NamedQueries({@NamedQuery(name = "MotriceRefTosp.getAll", query = "SELECT t FROM MotriceRefTospEntity t"),
        @NamedQuery(name = "MotriceRefTosp.getById", query = "SELECT t FROM MotriceRefTospEntity t WHERE t.idMotriceRefTosp = :idMotriceRefTosp"),
        @NamedQuery(name = "MotriceRefTosp.getUnique",
                query = "SELECT t FROM MotriceRefTospEntity t where t.codeMotriceRefTosp = :codeTosp and t.compagnie = :compagnie"),
        @NamedQuery(name = "MotriceRefTosp.getByCompagnie",
                query = "SELECT t FROM MotriceRefTospEntity t where t.compagnie = :compagnie"),})
public class MotriceRefTospEntity {
    ...
    @ForeignKey(name = "FK_motrice_ref_tosp_idCompagnie")
