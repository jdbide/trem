      ...
      try {
         ...
         if (!context.getParsingErrors().isEmpty()) {
            ...
            for (ExcelImportException error : context.getParsingErrors()) {
               System.out.println("    " + error.getMessage() + " -> " + error.getStackTrace()[0].toString());
                  ...
                  parsing.add(error.getMessage() + (error.getCell() != null?  "sur la cellule " + error.getCell().getColumnIndex() + error.getCell().getRowIndex() + " de la feuille " + error.getCell().getSheet().getSheetName():""));
         ...
         if (!context.getValidationErrors().isEmpty()) {
            ...
            for (ExcelImportException error : context.getValidationErrors()) {
               System.out.println("    " + error.getMessage() + " -> " + error.getStackTrace()[0].toString());
               validation.add(error.getMessage() + ( error.getCell() != null?  "sur la cellule " + error.getCell().getColumnIndex() + error.getCell().getRowIndex() + " de la feuille " + error.getCell().getSheet().getSheetName():""));
         ...
         if (!context.getExtractionErrors().isEmpty()) {
            ...
            for (ExcelImportException error : context.getExtractionErrors()) {
               System.out.println("    " + error.getMessage() + " -> " + error.getStackTrace()[0].toString());
               extraction.add(error.getMessage() + (error.getCell() != null?  "sur la cellule " + error.getCell().getColumnIndex() + error.getCell().getRowIndex() + " de la feuille " + error.getCell().getSheet().getSheetName():""));
            }
         }
         responseBean.setStatus(false);
