...
public class TraiteMotriceRegimeRestriction implements ITraiteMotriceRegime {
	...
	public void traite(MotriceTrainTrancheEntity motriceTrainTrancheEntity,
		...
		IMultipleInsertRequestGenerator generatorRestriction = mapGeneratorTablesMotriceRegime
				.get(MotriceRegimeRestrictionEntity.class);
		...
		Query queryRRestriction = entityManager.createNativeQuery(
				"SELECT restr.CDDS_INPT_RR_MONT AS origineMotriceRegimeRestriction, restr.CDDS_INPT_RR_DESC AS destinationMotriceRegimeRestriction, cdem.CDEM_REGI AS motriceRegime "
						...
						+ "AND restr.CDDS_CDEM_IND_FER = cdem.CDEM_TRA1_IND_FER "
						+ "AND restr.CDDS_CDEM_NUM_TRA1 = cdem.CDEM_TRA1_NUM_TRA1 "
		...
		List<ASousRegimeTranche> listeRestrictions = (List<ASousRegimeTranche>) atomicTranche.get()
				.getAttributsField(Restriction.class);
