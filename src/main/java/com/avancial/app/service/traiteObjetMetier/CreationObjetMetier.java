...
public class CreationObjetMetier {
	...
	public JeuDonneesPlanTransport creationPlanTransport(String environnementCompagnie, Status status,
		...
		logger.info("Creation objet metier");
		...
		for (MotriceTrainTrancheEntity resTrainTranche : trainsTranches) {
			...
			logger.info("Remplissage du train " + resTrainTranche.getTrainNumberMotriceTrainTranche() + " , tranche "
					+ resTrainTranche.getTrancheNumberMotriceTrainTranche());
			...
			logger.info("Fin de Remplissage du train " + resTrainTranche.getTrainNumberMotriceTrainTranche()
					+ " , tranche " + resTrainTranche.getTrancheNumberMotriceTrainTranche());
