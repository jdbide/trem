...
/**
 * Filtre des dessertes d'une tranche en fonction de l'inclusion ou non de gares dans celles-ci.
 * 
...
public abstract class AFiltreGareDesserteTranche implements IFiltre<Tranche> {
   ...
   /**
    * Traitement d'une desserte, en fonction de la présence ou absence d'une gare de la liste dans celle-ci
    * 
    * @param garePresente
    *           Booléen indiquant si une gare de la liste est présente (<tt>true</tt>) ou absente ({@code false})
    * @param desserte
    *           Desserte dans laquelle la présence d'une gare de la liste a été testée
    */
   protected abstract void traiteDesserte(boolean garePresente, Desserte desserte);

   /**
    * Traitement de la tranche résultat une fois que toutes ses dessertes ont été testées
    * 
    * @param tranche
