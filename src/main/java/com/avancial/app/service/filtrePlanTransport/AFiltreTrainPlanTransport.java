...
/**
 * Filtre d'un plan de transport à partir d'un filtre de train : appelle le {@link FiltreTrainPlanTransport} appliqué au {@link IFiltre} <
 * {@link Train} > donné au constructeur.
 * 
