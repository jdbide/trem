...
import com.avancial.app.service.controlePlanTransport.ControleTrain;
 ...
 *
 */
public class ComparePlanTransportControl extends AChaineComparePlanTransport {
    ...
    public MapComparaisonPlanTransport compare(IPlanTransport comparableAncien, IPlanTransport comparableNouveau)
        ...
        IComparePlanTransport comparePlanTransport = new ControleTrain();
