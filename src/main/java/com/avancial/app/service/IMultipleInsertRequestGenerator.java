...
public interface IMultipleInsertRequestGenerator {
    ...
    /**
     * Ajoute dans la requête les valeurs pour une ligne supplémentaire à
     * insérer
     * 
     * @param colValues
     ...
     * 
     * @return Requête d'insertion dans la table, ou null si la requête n'a pas
     *         été initialisée et/ou qu'aucune valeur n'a été ajoutée.<br>
     *         Si la requête est composée de plusieurs requêtes à la suite,
     *         elles sont séparées par des points virgule.
     */
