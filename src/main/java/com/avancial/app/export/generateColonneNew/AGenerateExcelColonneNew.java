...
public abstract class AGenerateExcelColonneNew implements IGenerateExcelColonneNew {
   ...
   public void generate(List<ASousRegimeTranche> listeAttributs, int numColonne, ExcelTools excelTools) {
      ...
      for (ASousRegimeTranche aSousRegimeTranche : listeAttributs) {
         excelTools.createCellTexteWithStyle(numColonne, this.printExcelSousRegimeTranche.printRegime(aSousRegimeTranche),
               excelTools.styleBorderNotRight);
         excelTools.createCellTexteWithStyle(numColonne + 1, this.printExcelSousRegimeTranche.printValue(aSousRegimeTranche),
