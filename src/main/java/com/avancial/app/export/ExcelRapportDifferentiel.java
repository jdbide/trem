    ...
    */
    ...
    private List<IComparaisonPlanTransport> orderByTypeComparaisonPlanTransport(String typeComparaison) {
        ...
        for (IComparaisonPlanTransport comparaison : this.datas) {
            if (((ComparaisonPlanTransport) comparaison).getTypeComparaisonPlanTransport().toString()
                    .equals(typeComparaison))
        ...
        for (IComparaisonPlanTransport comparaison : this.datas) {
            ...
            if (data.getTypeComparaisonPlanTransport().toString().equals(nameCurrentSheet)) {
                ...
                this.excelTools.createCellTexte(3,
                        mapPlansDeTransport.get(1).get().getTrainByNumeroTrain(data.getNumeroTrain())
                                .getTrancheByNumeroTranche(data.getNumeroTranche()).getRegime().getCodeRegime());
            }
        }
    }
        ...
        for (int i = 0; i < this.datas.size(); i++) {
            ...
            if (data.getTypeComparaisonPlanTransport().toString().equals(SHEET_REGIMESPLIT)) {
                ...
                for (int j = i; j < this.datas.size(); j++) {
                    ...
                    if (dataCompare.getTypeComparaisonPlanTransport().toString().equals(SHEET_REGIMESPLIT)
                            && dataCompare.getNumeroTrain().equals(data.getNumeroTrain())
                            && dataCompare.getNumeroTranche().equals(data.getNumeroTranche())
                            && dataCompare.getNouveauField().getClass().toString()
                                    .equals(data.getNouveauField().getClass().toString())) {
                        if (!isfirst)
                            this.excelTools.createRow(this.ligne++);
                        ...
                        if (data.getNouveauField().getClass().getSimpleName()
                                .equals(APP_Field.FareProfile.toString())) {
                            this.excelTools.createCellTexte(3,
                                    this.getFieldName(data.getNouveauField().getClass().getSimpleName()));
                            this.excelTools.createCellTexte(4,
                                    ((FareProfile) (((ComparaisonPlanTransport) this.datas.get(j)).getNouveauField()))
                                            .getRegime().getCodeRegime());
                            this.excelTools.createCellTexte(5,
                                    ((FareProfile) (((ComparaisonPlanTransport) this.datas.get(j)).getNouveauField()))
                                            .getFareProfileCode());
                        }
                        else if (data.getNouveauField().getClass().getSimpleName()
                                .equals(APP_Field.CodeSat.toString())) {
                            this.excelTools.createCellTexte(3,
                                    this.getFieldName(data.getNouveauField().getClass().getSimpleName()));
                            this.excelTools.createCellTexte(4,
                                    ((CodeSat) (((ComparaisonPlanTransport) this.datas.get(j)).getNouveauField()))
                                            .getRegime().getCodeRegime());
                            this.excelTools.createCellTexte(5,
                                    ((CodeSat) (((ComparaisonPlanTransport) this.datas.get(j)).getNouveauField()))
                                            .getCodeSat());
                                ...
                                .equals(APP_Field.Desserte.toString())) {
                            this.excelTools.createCellTexte(3,
                                    this.getFieldName(data.getNouveauField().getClass().getSimpleName()));
                            this.excelTools.createCellTexte(4,
                                    ((Desserte) (((ComparaisonPlanTransport) this.datas.get(j)).getNouveauField()))
                                            .getRegime().getCodeRegime());
                            for (GareHoraire gareHoraire : ((Desserte) (((ComparaisonPlanTransport) this.datas.get(j))
                                    .getNouveauField())).getGareHoraires()) {
                                this.excelTools.createCellTexte(5,
                                        (gareHoraire.getGare().getCodeGare() + "("
                                                + ((gareHoraire.getHoraire().getHoraireDebut() != null)
                                                        ? gareHoraire.getHoraire().getHoraireDebut().toString() : "/")
                                                + ")\n"));
                            }
                        }
                        else if (data.getNouveauField().getClass().getSimpleName()
                                .equals(APP_Field.Distribution.toString())) {
                            this.excelTools.createCellTexte(3,
                                    this.getFieldName(data.getNouveauField().getClass().getSimpleName()));
                            this.excelTools.createCellTexte(4,
                                    ((Distribution) (((ComparaisonPlanTransport) this.datas.get(j)).getNouveauField()))
                                            .getRegime().getCodeRegime());
                            this.excelTools.createCellTexte(5,
                                    ((Distribution) (((ComparaisonPlanTransport) this.datas.get(j)).getNouveauField()))
                                            .getIndiceDistribution());
                        }
                        else if (data.getNouveauField().getClass().getSimpleName()
                                .equals(APP_Field.OrigineDestination.toString())) {

                            this.excelTools.createCellTexte(3,
                                    this.getFieldName(data.getNouveauField().getClass().getSimpleName()));
                            this.excelTools.createCellTexte(4,
                                    ((OrigineDestination) (((ComparaisonPlanTransport) this.datas.get(j))
                                            .getNouveauField())).getRegime().getCodeRegime());
                            /**
                            ...
                            this.excelTools.createCellTexte(3,
                                    this.getFieldName(data.getNouveauField().getClass().getSimpleName()));
                            this.excelTools.createCellTexte(4,
                                    ((Repas) (((ComparaisonPlanTransport) this.datas.get(j)).getNouveauField()))
                                            .getRegime().getCodeRegime());
                            this.excelTools.createCellTexte(5,
                                    ((Repas) (((ComparaisonPlanTransport) this.datas.get(j)).getNouveauField()))
                                            .getTypeRepas().toString());

                        }
                        else if (data.getNouveauField().getClass().getSimpleName()
                                .equals(APP_Field.Restriction.toString())) {

                            this.excelTools.createCellTexte(3,
                                    this.getFieldName(data.getNouveauField().getClass().getSimpleName()));
                            this.excelTools.createCellTexte(4,
                                    ((Restriction) (((ComparaisonPlanTransport) this.datas.get(j)).getNouveauField()))
                                            .getRegime().getCodeRegime());
                            this.excelTools
                                    .createCellTexte(5,
                                            ((Restriction) (((ComparaisonPlanTransport) this.datas.get(j))
                                                    .getNouveauField())).getType().toString()
                                                    + " from "
                                                    + ((Restriction) (((ComparaisonPlanTransport) this.datas.get(j))
                                                            .getNouveauField())).getOrigine().getCodeGare()
                                                    + "to"
                                                    + ((Restriction) (((ComparaisonPlanTransport) this.datas.get(j))
                                                            .getNouveauField())).getDestination().toString());

                        }
                        else if (data.getNouveauField().getClass().getSimpleName()
                                .equals(APP_Field.ServiceABord.toString())) {

                            this.excelTools.createCellTexte(3,
                                    this.getFieldName(data.getNouveauField().getClass().getSimpleName()));
                            this.excelTools.createCellTexte(4,
                                    ((ServiceABord) (((ComparaisonPlanTransport) this.datas.get(j)).getNouveauField()))
                                            .getRegime().getCodeRegime());
                            this.excelTools
                                    .createCellTexte(5,
                                            ((ServiceABord) (((ComparaisonPlanTransport) this.datas.get(j))
                                                    .getNouveauField())).getCodeService()
                                                    + " - "
                                                    + ((ServiceABord) (((ComparaisonPlanTransport) this.datas.get(j))
                                                            .getNouveauField())).getClasse().toString()
                                                    + " - "
                                                    + ((ServiceABord) (((ComparaisonPlanTransport) this.datas.get(j))
                                                            .getNouveauField())).getOrigine().getCodeGare()
                                                    + " to "
                                                    + ((ServiceABord) (((ComparaisonPlanTransport) this.datas.get(j))
                                                            .getNouveauField())).getDestination().getCodeGare());
                        }
                        else if (data.getNouveauField().getClass().getSimpleName()
                                .equals(APP_Field.TypeEquipement.toString())) {
                            this.excelTools.createCellTexte(3,
                                    this.getFieldName(data.getNouveauField().getClass().getSimpleName()));
                            this.excelTools.createCellTexte(4,
                                    ((TypeEquipement) (((ComparaisonPlanTransport) this.datas.get(j))
                                            .getNouveauField())).getRegime().getCodeRegime());
                            this.excelTools.createCellTexte(5,
                                    ((TypeEquipement) (((ComparaisonPlanTransport) this.datas.get(j))
                                            .getNouveauField())).getTypeEquipement());
                        }

                        else if (data.getNouveauField().getClass().getSimpleName()
                                .equals(APP_Field.Specification.toString())) {

                            this.excelTools.createCellTexte(3,
                                    this.getFieldName(data.getNouveauField().getClass().getSimpleName()));
                            this.excelTools.createCellTexte(4,
                                    ((Specification) (((ComparaisonPlanTransport) this.datas.get(j)).getNouveauField()))
                                            .getRegime().getCodeRegime());

                            String valueSpecification = "";

                            for (Compartiment compartiment : ((Specification) (((ComparaisonPlanTransport) this.datas
                                    .get(j)).getNouveauField())).getVoiture().getCompartiments()) {
                                for (Siege siege : compartiment.getSieges()) {
                                    valueSpecification += "Coach "
                                            + ((Specification) (((ComparaisonPlanTransport) this.datas.get(j))
                                                    .getNouveauField())).getVoiture().getNumeroVoiture()
                                            + " ,";
                                    valueSpecification += " Seat " + siege.getNumeroSiege() + ", "
                                            + ((Specification) (((ComparaisonPlanTransport) this.datas.get(j))
                                                    .getNouveauField())).getEtat().toString();
                                    valueSpecification += "\n";
                                }
                                ...
                                if (compartiment.getNumeroCompartiment() != null) {
                                    valueSpecification += "Coach "
                                            + ((Specification) (((ComparaisonPlanTransport) this.datas.get(j))
                                                    .getNouveauField())).getVoiture().getNumeroVoiture()
                                            + " ,";
                                    valueSpecification += " Compartment " + compartiment.getNumeroCompartiment() + ", "
                                            + ((Specification) (((ComparaisonPlanTransport) this.datas.get(j))
                                                    .getNouveauField())).getEtat().toString();
                                    valueSpecification += "\n";
                                }
                            ...
                            this.excelTools.createCellTexte(5, valueSpecification);
                                ...
                                .equals(APP_Field.Composition.toString())) {
                            this.excelTools.createCellTexte(3,
                                    this.getFieldName(data.getNouveauField().getClass().getSimpleName()));
                            this.excelTools.createCellTexte(4,
                                    ((Composition) (((ComparaisonPlanTransport) this.datas.get(j)).getNouveauField()))
                                            .getRegime().getCodeRegime());

                            String valueComposition = "";
                            for (int h = 0; h < (((Composition) (((ComparaisonPlanTransport) this.datas.get(j))
                                    .getNouveauField())).getVoitures()).size(); h++) {
                                valueComposition += (((Composition) (((ComparaisonPlanTransport) this.datas.get(j))
                                        .getNouveauField())).getVoitures()).get(h).getNumeroVoiture();
                                if (h < (((Composition) (((ComparaisonPlanTransport) this.datas.get(j))
                                        .getNouveauField())).getVoitures()).size() - 1)
                                    valueComposition += ", ";
                            }

                            valueComposition += " = ";
                            valueComposition += ((Composition) (((ComparaisonPlanTransport) this.datas.get(j))
                                    .getNouveauField())).getCodeRame() + ",";
                            valueComposition += valueComposition += ((Composition) (((ComparaisonPlanTransport) this.datas
                                    .get(j)).getNouveauField())).getCodeClasse() + ",";
                            valueComposition += valueComposition += ((Composition) (((ComparaisonPlanTransport) this.datas
                                    .get(j)).getNouveauField())).getCodeDiag();
            ...
            if (data.getTypeComparaisonPlanTransport().toString().equals(SHEET_MODIFY)) {
                ...
                if (data.getNouveauField().getClass().getSimpleName().equals(APP_Field.FareProfile.toString())) {
                    this.excelTools.createCellTexte(3,
                            this.getFieldName(data.getNouveauField().getClass().getSimpleName()));
                    this.excelTools.createCellTexte(4,
                            ((FareProfile) data.getNouveauField()).getRegime().getCodeRegime());
                    ...
                    this.excelTools.createCellTexte(3,
                            this.getFieldName(data.getNouveauField().getClass().getSimpleName()));
                    this.excelTools.createCellTexte(4,
                            ((Distribution) data.getNouveauField()).getRegime().getCodeRegime());
                    ...
                    this.excelTools.createCellTexte(3,
                            this.getFieldName(data.getNouveauField().getClass().getSimpleName()));
                    this.excelTools.createCellTexte(4,
                            ((OrigineDestination) data.getNouveauField()).getRegime().getCodeRegime());
                    ...
                    this.excelTools.createCellTexte(3,
                            this.getFieldName(data.getNouveauField().getClass().getSimpleName()));
                    this.excelTools.createCellTexte(4,
                            ((Restriction) data.getNouveauField()).getRegime().getCodeRegime());
                    String ancienValue = ((Restriction) data.getAncienField()).getType().toString() + " from "
                            + ((Restriction) data.getAncienField()).getOrigine().getCodeGare() + "to"
                            + ((Restriction) data.getAncienField()).getDestination().toString();
                    String nouvelleValue = ((Restriction) data.getNouveauField()).getType().toString() + " from "
                            + ((Restriction) data.getNouveauField()).getOrigine().getCodeGare() + "to"
                            + ((Restriction) data.getNouveauField()).getDestination().toString();
                    ...
                    this.excelTools.createCellTexte(3,
                            this.getFieldName(data.getNouveauField().getClass().getSimpleName()));
                    this.excelTools.createCellTexte(4,
                            ((ServiceABord) data.getNouveauField()).getRegime().getCodeRegime());

                    String ancienValue = ((ServiceABord) data.getAncienField()).getCodeService() + " - "
                            + ((ServiceABord) data.getAncienField()).getClasse().toString() + " - "
                            + ((ServiceABord) data.getAncienField()).getOrigine().getCodeGare() + " to "
                            + ((ServiceABord) data.getAncienField()).getDestination().getCodeGare();
                    String nouvelleValue = ((ServiceABord) data.getNouveauField()).getCodeService() + " - "
                            + ((ServiceABord) data.getNouveauField()).getClasse().toString() + " - "
                            + ((ServiceABord) data.getNouveauField()).getOrigine().getCodeGare() + " to "
                    ...
                    this.excelTools.createCellTexte(3,
                            this.getFieldName(data.getNouveauField().getClass().getSimpleName()));
                    this.excelTools.createCellTexte(4,
                            ((TypeEquipement) data.getNouveauField()).getRegime().getCodeRegime());
                    ...
                    this.excelTools.createCellTexte(3,
                            this.getFieldName(data.getNouveauField().getClass().getSimpleName()));
                    this.excelTools.createCellTexte(4,
                            ((Specification) data.getNouveauField()).getRegime().getCodeRegime());
                    String ancienSpecification = "";
                    for (Compartiment compartiment : ((Specification) data.getAncienField()).getVoiture()
                            .getCompartiments()) {
                        for (Siege siege : compartiment.getSieges()) {
                            ancienSpecification += "Coach "
                                    + ((Specification) data.getAncienField()).getVoiture().getNumeroVoiture() + " ,";
                            ancienSpecification += " Seat " + siege.getNumeroSiege() + ", "
                                    + ((Specification) data.getAncienField()).getEtat().toString();
                            ancienSpecification += "\n";
                        }
                        ...
                        if (compartiment.getNumeroCompartiment() != null) {
                            ancienSpecification += "Coach "
                                    + ((Specification) data.getAncienField()).getVoiture().getNumeroVoiture() + " ,";
                            ancienSpecification += " Compartment " + compartiment.getNumeroCompartiment() + ", "
                                    + ((Specification) data.getAncienField()).getEtat().toString();
                            ancienSpecification += "\n";
                        }
                    }
                    ...
                    for (Compartiment compartiment : ((Specification) data.getNouveauField()).getVoiture()
                            .getCompartiments()) {
                        for (Siege siege : compartiment.getSieges()) {
                            nouvelleSpecification += "Coach "
                                    + ((Specification) data.getNouveauField()).getVoiture().getNumeroVoiture() + " ,";
                            nouvelleSpecification += " Seat " + siege.getNumeroSiege() + ", "
                                    + ((Specification) data.getNouveauField()).getEtat().toString();
                        ...
                        if (compartiment.getNumeroCompartiment() != null) {
                            nouvelleSpecification += "Coach "
                                    + ((Specification) data.getNouveauField()).getVoiture().getNumeroVoiture() + " ,";
                            nouvelleSpecification += " Compartment " + compartiment.getNumeroCompartiment() + ", "
                                    + ((Specification) data.getNouveauField()).getEtat().toString();
                            nouvelleSpecification += "\n";
                        }
                    }
                    ...
                    this.excelTools.createCellTexte(3,
                            this.getFieldName(data.getNouveauField().getClass().getSimpleName()));
                    this.excelTools.createCellTexte(4,
                            ((Composition) data.getNouveauField()).getRegime().getCodeRegime());
                    String ancienComposition = "";
                    for (int h = 0; h < (((Composition) data.getAncienField()).getVoitures()).size(); h++) {
                        ancienComposition += (((Composition) data.getAncienField()).getVoitures()).get(h)
                                .getNumeroVoiture();
                    ...
                    for (int h = 0; h < (((Composition) data.getNouveauField()).getVoitures()).size(); h++) {
                        nouvelleComposition += (((Composition) data.getNouveauField()).getVoitures()).get(h)
                                .getNumeroVoiture();
    ...
    private void generateContentForSheetNew() throws ClassNotFoundException, IOException {
        ...
        for (IComparaisonPlanTransport comparaison : this.datas) {
            ...
            if (data.getTypeComparaisonPlanTransport().toString().equals(SHEET_NEW)) {
                ...
                // this.writeTrainTrancheForSheetNew(data, currentTrain,
                // currentTranche);
                // Dessertes

                List<Desserte> dessertes = (List<Desserte>) currentTranche
                        .getByAttributsField(APP_Field.Desserte.toString());
                ...
                for (Desserte desserte : dessertes) {
                    ...
                    this.writeTrainTrancheForSheetNew(data, currentTrain, currentTranche);
                    this.excelTools.createCellTexteWithStyle(7, desserte.getRegime().getCodeRegime(),
                    ...
                    for (GareHoraire gareHoraire : desserte.getGareHoraires()) {
                        ...
                        gareHorair += gareHoraire.getGare().getCodeGare() + " ("
                                + ((gareHoraire.getHoraire().getHoraireDebut() != null)
                                        ? gareHoraire.getHoraire().getHoraireDebut().getHours() + ":"
                                                + gareHoraire.getHoraire().getHoraireDebut().getMinutes()
                                        : "/")
                                + " - "
                                + ((gareHoraire.getHoraire().getHoraireFin() != null)
                                        ? gareHoraire.getHoraire().getHoraireFin().getHours() + ":"
                                                + gareHoraire.getHoraire().getHoraireFin().getMinutes()
                                        : "/")
                                + ")\n";
                    }
                ...
                List<OrigineDestination> ods = (List<OrigineDestination>) currentTranche
                        .getByAttributsField(APP_Field.OrigineDestination.toString());
                ...
                for (OrigineDestination od : ods) {
                    if (!oldRegime.equals(od.getRegime().getCodeRegime())) {
                        ...
                        if (!isFirst) {
                            this.excelTools.addMergedRegion(firstLine, line - 1, 9, 9,
                                    this.excelTools.styleBorderNotRight);
                            firstLine = line;
                        }
                    }
                    ...
                    this.excelTools.createCellTexteByLigneAndStyle(9, od.getRegime().getCodeRegime(), line,
                            this.excelTools.styleBorderNotRight);
                    this.excelTools.createCellTexteByLigneAndStyle(10,
                            od.getOrigine().getCodeGare() + " - " + od.getDestination().getCodeGare(), line,
                            this.excelTools.styleBorderNotLeft);
                ...
                List<Distribution> distributions = (List<Distribution>) currentTranche
                        .getByAttributsField(APP_Field.Distribution.toString());
                line = debutRowTrain;
                isFirst = true;
                oldRegime = "";
                firstLine = line;
                ...
                for (Distribution distribution : distributions) {
                    if (!oldRegime.equals(distribution.getRegime().getCodeRegime())) {
                        ...
                        if (!isFirst) {
                            this.excelTools.addMergedRegion(firstLine, line - 1, 11, 11,
                                    this.excelTools.styleBorderNotRight);
                            firstLine = line;
                        }
                    }
                    ...
                    this.excelTools.createCellTexteByLigneAndStyle(11, distribution.getRegime().getCodeRegime(), line,
                            this.excelTools.styleBorderNotRight);
                    this.excelTools.createCellTexteByLigneAndStyle(12, distribution.getIndiceDistribution(), line,
                            this.excelTools.styleBorderNotLeft);
                ...
                List<Composition> compositions = (List<Composition>) currentTranche
                        .getByAttributsField(APP_Field.Composition.toString());
                line = debutRowTrain;
                isFirst = true;
                oldRegime = "";
                firstLine = line;
                ...
                for (Composition composition : compositions) {
                    if (!oldRegime.equals(composition.getRegime().getCodeRegime())) {
                        ...
                        newCompo = "";
                        if (!isFirst) {
                            this.excelTools.addMergedRegion(firstLine, line - 1, 13, 13,
                                    this.excelTools.styleBorderNotRight);
                            this.excelTools.addMergedRegion(firstLine, line - 1, 14, 14,
                                    this.excelTools.styleBorderNotLeftNotRight);
                            this.excelTools.addMergedRegion(firstLine, line - 1, 15, 15,
                                    this.excelTools.styleBorderNotLeftNotRight);
                            this.excelTools.addMergedRegion(firstLine, line - 1, 16, 16,
                                    this.excelTools.styleBorderNotLeftNotRight);
                            this.excelTools.addMergedRegion(firstLine, line - 1, 17, 17,
                                    this.excelTools.styleBorderNotLeftNotRight);
                            firstLine = line;
                        }
                    }
                    ...
                    this.excelTools.createCellTexteByLigneAndStyle(13, composition.getRegime().getCodeRegime(), line,
                            this.excelTools.styleBorderNotRight);
                    ...
                    for (int l = firstLine; l <= line; l++)
                        this.excelTools.createCellTexteByLigneAndStyle(14, classes, l,
                                this.excelTools.styleBorderNotLeftNotRight);
                    ...
                    for (int l = firstLine; l <= line; l++)
                        this.excelTools.createCellTexteByLigneAndStyle(16, rameCode, l,
                                this.excelTools.styleBorderNotLeftNotRight);

                    this.excelTools.createCellTexteByLigneAndStyle(17, composition.getCodeRm(), line,
                            this.excelTools.styleBorderNotLeftNotRight);
                    ...
                    for (int l = firstLine; l <= line; l++)
                        this.excelTools.createCellTexteByLigneAndStyle(15, newCompo, l,
                                this.excelTools.styleBorderNotLeftNotRight);
                ...
                List<CodeSat> codeSats = (List<CodeSat>) currentTranche
                        .getByAttributsField(APP_Field.CodeSat.toString());
                line = debutRowTrain;
                isFirst = true;
                firstLine = line;
                ...
                for (CodeSat codeSat : codeSats) {
                    ...
                    this.excelTools.createCellTexteByLigneAndStyle(18, codeSat.getRegime().getCodeRegime(), line,
                            this.excelTools.styleBorderNotRight);
                    this.excelTools.createCellTexteByLigneAndStyle(19, codeSat.getCodeSat(), line,
                            this.excelTools.styleBorderNotLeft);
                ...
                List<FareProfile> fareProfiles = (List<FareProfile>) currentTranche
                        .getByAttributsField(APP_Field.FareProfile.toString());
                line = debutRowTrain;
                isFirst = true;
                firstLine = line;
                ...
                for (FareProfile fareProfile : fareProfiles) {
                    ...
                    this.excelTools.createCellTexteByLigneAndStyle(20, fareProfile.getRegime().getCodeRegime(), line,
                            this.excelTools.styleBorderNotRight);
                    this.excelTools.createCellTexteByLigneAndStyle(21, fareProfile.getFareProfileCode(), line,
                            this.excelTools.styleBorderNotLeft);
                ...
                List<TypeEquipement> typeEquipements = (List<TypeEquipement>) currentTranche
                        .getByAttributsField(APP_Field.TypeEquipement.toString());
                line = debutRowTrain;
                isFirst = true;
                firstLine = line;
                for (TypeEquipement typeEquipement : typeEquipements) {
                    ...
                    this.excelTools.createCellTexteByLigneAndStyle(22, typeEquipement.getRegime().getCodeRegime(), line,
                            this.excelTools.styleBorderNotRight);
                    this.excelTools.createCellTexteByLigneAndStyle(23, typeEquipement.getTypeEquipement(), line,
                            this.excelTools.styleBorderNotLeft);
                ...
                List<ServiceABord> services = (List<ServiceABord>) currentTranche
                        .getByAttributsField(APP_Field.ServiceABord.toString());
                line = debutRowTrain;
                isFirst = true;
                oldRegime = "";
                firstLine = line;
                ...
                for (ServiceABord service : services) {
                    if (!oldRegime.equals(service.getRegime().getCodeRegime())) {
                        ...
                        classes = "";
                        if (!isFirst) {
                            this.excelTools.addMergedRegion(firstLine, line - 1, 24, 24,
                                    this.excelTools.styleBorderNotRight);
                            this.excelTools.addMergedRegion(firstLine, line - 1, 25, 25,
                                    this.excelTools.styleBorderNotLeft);
                    ...
                    this.excelTools.createCellTexteByLigneAndStyle(24, service.getRegime().getCodeRegime(), line,
                            this.excelTools.styleBorderNotRight);

                    if (!classes.equals(""))
                        classes += "\n";

                    classes += service.getCodeService() + " - " + service.getClasse().toString() + " - "
                            + service.getOrigine().getCodeGare() + " to " + service.getDestination().getCodeGare();

                    for (int l = firstLine; l <= line; l++)
                        this.excelTools.createCellTexteByLigneAndStyle(25, classes, l,
                                this.excelTools.styleBorderNotLeft);
                ...
                for (Repas repas : listRepas) {
                    ...
                    this.excelTools.createCellTexteByLigneAndStyle(26, repas.getRegime().getCodeRegime(), line,
                            this.excelTools.styleBorderNotRight);
                    this.excelTools.createCellTexteByLigneAndStyle(27, repas.getTypeRepas().toString(), line,
                            this.excelTools.styleBorderNotLeft);
                ...
                List<Specification> specifs = (ArrayList<Specification>) currentTranche
                        .getByAttributsField(APP_Field.Specification.toString());
                line = debutRowTrain;
                isFirst = true;
                oldRegime = "";
                firstLine = line;
                ...
                for (Specification specif : specifs) {
                    if (!oldRegime.equals(specif.getRegime().getCodeRegime())) {
                        ...
                        if (!isFirst) {
                            this.excelTools.addMergedRegion(firstLine, line - 1, 28, 28,
                                    this.excelTools.styleBorderNotRight);
                            this.excelTools.addMergedRegion(firstLine, line - 1, 29, 29,
                                    this.excelTools.styleBorderNotLeftNotRight);
                            firstLine = line;
                        }
                    }
                    ...
                    this.excelTools.createCellTexteByLigneAndStyle(28, specif.getRegime().getCodeRegime(), line,
                            this.excelTools.styleBorderNotRight);
                ...
                List<Restriction> restrictions = (List<Restriction>) currentTranche
                        .getByAttributsField(APP_Field.Restriction.toString());
                line = debutRowTrain;
                isFirst = true;
                oldRegime = "";
                firstLine = line;
                ...
                for (Restriction restriction : restrictions) {
                    if (!oldRegime.equals(restriction.getRegime().getCodeRegime())) {
                        ...
                        if (!isFirst) {
                            this.excelTools.addMergedRegion(firstLine, line - 1, 30, 30,
                                    this.excelTools.styleBorderNotRight);
                            this.excelTools.addMergedRegion(firstLine, line - 1, 31, 31,
                                    this.excelTools.styleBorderNotLeft);
                            firstLine = line;
                        }
                    }
                    ...
                    this.excelTools.createCellTexteByLigneAndStyle(30, restriction.getRegime().getCodeRegime(), line,
                            this.excelTools.styleBorderNotRight);
                    ...
                    for (int l = firstLine; l <= line; l++)
                        this.excelTools.createCellTexteByLigneAndStyle(31, restr, l,
                                this.excelTools.styleBorderNotLeft);
                ...
                System.out.println("******************************************* FIN D'UN TRAIN TRANCHE "
                        + currentTrain.getNumeroTrain() + ", " + currentTranche.getNumeroTranche() + " => "
                        + ((cntTraiTranche / sizeAllCompa) * 100)
                        + " % ************************************************************");
                cntTraiTranche++;
            }
