...
import com.avancial.app.export.control.ExcelRapportControleSheetCircul;
...
public class ExcelRapportDifferentielSheetFactory {
   ...
   public ExcelRapportDifferentielSheetFactory() {
      ...
      this.map.put(ExcelRapportControle.ERR_CIRCUL, new ExcelRapportControleSheetCircul());
