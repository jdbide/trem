...
public class ExcelTools {
    ...
    /**
     * Classe composée d'un style et d'une couleur, utilisée comme clé dans la
     * map mapStyleColor.<br>
     * Pour cette clé, on compare les styles uniquement sur la base des valeurs
     * de leurs attributs BorderLeft et BorderRight.
     * 
    ...
    private class CellStyleColor {
        ...
        public boolean equals(Object obj) {
            ...
            return cellStyleColor.cellStyle.getBorderLeft() == this.cellStyle.getBorderLeft()
                    ...
                    && cellStyleColor.color.getBlue() == this.color.getBlue()
                    && cellStyleColor.color.getGreen() == this.color.getGreen()
    ...
    /**
     * Ajoute une couleur de fond au style passé en paramètre. On cherche
     * d'abord ce style dans la map mapStyleColor, et s'il n'y est pas, le style
     * est cloné et on lui ajoute la couleur, puis on l'ajoute à la map. Cela
     * empêche de devoir re-créer un style à chaque fois qu'on en a besoin.
     * 
     * @param sourceStyle
     * @param c
     * @return
