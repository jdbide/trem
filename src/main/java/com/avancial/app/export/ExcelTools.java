...
public class ExcelTools {
   ...
   /**
    * Set la feuille Excel, et initialise l'itérateur sur les lignes
    * 
    * @param sheetIndex
   ...
   public void setRow(int row) {
      ...
      this.cellIterator = this.ligneSheet.cellIterator();
   }
   ...
   /**
    * Prochaine itération sur les lignes de la feuille en cours, initialise l'itérateur sur les cellules de cette nouvelle ligne
    * 
    * @return La ligne suivante dans le fichier, qui devient la nouvelle ligne courante
    */
   public Row getNextRow() {
      this.ligneSheet = this.rowIterator.next();
      this.cellIterator = this.ligneSheet.cellIterator();
    ...
    * 
    * @return {@code True} si et seulement si il reste des lignes à lire dans la feuille en cours
    */
   ...
   /**
    * Sette la cellule à lire dans la ligne en cours. L'itérateur sur les cellules est passé à {@code null}.
    * 
    * @param cellNumber
    *           Indice de la colonne
    * @return La nouvelle cellule courante
    */
   public Cell setCell(Integer cellNumber) {
      this.cell = this.ligneSheet.getCell(cellNumber);
    ...
    * 
    * @return La cellule suivante dans la ligne, qui devient la nouvelles cellule courante
    */
    ...
    * 
    * @return {@code True} si et seulement si il reste des cellules à lire dans la ligne en cours
    */
   ...
   /**
    * Initialise les styles définis en attributs publics de la classe
    */
   private void initStyle() {
      ...
      try {
         ...
         System.err.println(
               "WARN : Dans ExcelTools le Workbook étant de classe org.apache.poi.xssf.usermodel.HSSFWorkbook, tous les styles n'ont pas pu être créés.");
      }
