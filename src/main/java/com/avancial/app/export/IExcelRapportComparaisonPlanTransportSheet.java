...
/**
 * Génération d'une feuille (sheet) Excel d'une comparaison entre deux plans de transport.
 * 
 * @author heloise.guillemaud
 *
 */
public interface IExcelRapportComparaisonPlanTransportSheet {
    ...
    *           Map contenant les comparaisons entre deux plans de transport à afficher dans le rapport différentiel
