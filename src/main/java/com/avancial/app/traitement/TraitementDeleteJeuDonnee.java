...
public class TraitementDeleteJeuDonnee extends ATraitementLogDetail {
   ...
   protected void executeTraitement() throws Exception {
      try {
          ...
          */
         TypedQuery<MotriceTrainTrancheEntity> queryTrainTranches = this.em.createNamedQuery("MotriceTrainTranche.getByJeuDonnees", MotriceTrainTrancheEntity.class).setParameter("jeuDonnees", this.jeuDonnee);
          ...
          */
         this.em.createNamedQuery("MotriceTrainTranche.deleteByJeuDonnees").setParameter("jeuDonnees", this.jeuDonnee).executeUpdate();
