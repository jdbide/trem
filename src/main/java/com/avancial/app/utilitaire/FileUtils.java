...
public class FileUtils extends org.apache.commons.io.FileUtils
{
	 ...
	 * @see Cr�er un r�pertoire, avec les r�pertoire parent si il y en a. . Il faut noter que si la cr�ation �choue il est possible que certain r�pertoires parent aient �t� cr�es.
	 * @return true et seulement si le r�pertoire � �t� cr�e, avec les r�pertoire parent necessaire,  false sinon.
	 * */
	...
	public static boolean checksumFichierToMd5(String fichier, String fichierMd5, String encodageFichier) throws Exception
	{
