...
public class DeleteJeuDonneeTest {
    ...
    public void testDeleteDraft() throws Exception {
        JeuDonneeEntity jeuDonnee = this.entm.createNamedQuery("JeuDonneeEntity.getById", JeuDonneeEntity.class)
                .setParameter("idJeuDonnees", 17).getSingleResult();
        TraitementDeleteJeuDonnee test = new TraitementDeleteJeuDonnee();
        test.setJeuDonnee(jeuDonnee);
        test.execute();
