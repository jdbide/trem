...
public class TestRegimeEqpType {
   @Deployment
   ...
   @Test
   public void testRegimeEqpType() throws Exception {
      this.em.clear();
      ...
      mapGeneratorTablesMotriceRegime.get(MotriceRegimeEqpTypeEntity.class).executeRequest();
