...
public class TestRegimeService {
   @Deployment
   ...
   @Test
   public void testRegimeService() throws Exception {
      this.em.clear();
      ...
      ITraiteMotriceRegime traiteMotriceRegime = traiteMotriceRegimeFactory.getTraiteMotriceRegime(MotriceRegimeServiceEntity.class);
      ...
      mapGeneratorTablesMotriceRegime.get(MotriceRegimeServiceEntity.class).executeRequest();
