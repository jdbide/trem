...
public class TestRegimeSpecificty {
   @Deployment
   ...
   public void testRegimeDistribution() throws Exception {
      ...
      ITraiteMotriceRegime traiteMotriceRegime = traiteMotriceRegimeFactory.getTraiteMotriceRegime(MotriceRegimeSpecificityEntity.class);
      ...
      mapGeneratorTablesMotriceRegime.get(MotriceRegimeSpecificityEntity.class).executeRequest();
