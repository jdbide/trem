...
public class TestRegimeDistribution {
   @Deployment
   ...
   public void testRegimeDistribution() throws Exception {
      ...
      ITraiteMotriceRegime traiteMotriceRegime = traiteMotriceRegimeFactory.getTraiteMotriceRegime(MotriceRegimeDistributionEntity.class);
      ...
      mapGeneratorTablesMotriceRegime.get(MotriceRegimeDistributionEntity.class).executeRequest();
