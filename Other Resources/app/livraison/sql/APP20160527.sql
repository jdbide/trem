...
CREATE TABLE `tremas_import_tmdcath` (
  ...
  `CATH_CIRR_COD_CIE` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `CATH_DHDO` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  ...
  `CATH_TRCH_NUM` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `CATH_TRCH_NUM_TRA1` varchar(6) COLLATE utf8_bin DEFAULT NULL,
  `CATH_USER` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`idTMDCATH`),
  KEY `indNormal_cleCath` (`CATH_TRCH_COD_CIE`,`CATH_TRCH_NUM_TRA1`,`CATH_TRCH_IND_FER`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `tremas_import_tmdrame` (
  ...
  `RAME_DHDO` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  ...
  `RAME_TRCH_NUM_TRA1` varchar(6) COLLATE utf8_bin DEFAULT NULL,
  `RAME_USER` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`idTMDRAME`),
  KEY `indNormal_cleRame` (`RAME_TRCH_COD_CIE`,`RAME_TRCH_NUM_TRA1`,`RAME_TRCH_IND_FER`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `tremas_import_tmdvoit` (
  ...
  `VOIT_CIES_COD_GERE` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `VOIT_COD_ORIG` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `VOIT_DHDO` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `VOIT_INDCE_CLASST` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `VOIT_IND_ORIG` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `VOIT_NUM` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  ...
  `VOIT_TRCH_IND_FER` varchar(1) COLLATE utf8_bin DEFAULT NULL,
  `VOIT_TRCH_NUM` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `VOIT_TRCH_NUM_TRA1` varchar(6) COLLATE utf8_bin DEFAULT NULL,
  `VOIT_TYVO_NUM_TYP` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `VOIT_USER` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`idTMDVOIT`),
  KEY `indNormal_voittyvonumtype` (`VOIT_TYVO_NUM_TYP`),
  KEY `indNormal_cleVoit` (`VOIT_TRCH_COD_CIE`,`VOIT_TRCH_NUM_TRA1`,`VOIT_TRCH_IND_FER`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `tremas_import_tmdtyvo` (
  ...
  `TYVO_NUM_TYP` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `TYVO_DIAV_COD` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `TYVO_MARV_COD_MARQ` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `TYVO_CIES_COD_CIE` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `TYVO_TYEQ_COD` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `TYVO_PART_TYP` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `TYVO_USER` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `TYVO_DHDO` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `TYVO_MVT_MAJ` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `TYVO_DAT_PEREMP` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`idTMDTYVO`),
  KEY `indNormal_tyvonumtype` (`TYVO_NUM_TYP`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
