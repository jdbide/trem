...
DROP COLUMN `libelleCompagnie`,
DROP COLUMN `libelleEnvironnement`,
ADD COLUMN `idCompagnie`  int(11) NULL AFTER `idCompagnieEnvironnement`,
ADD COLUMN `idEnvironnement`  int(11) NULL AFTER `idCompagnie`,
DROP INDEX `indImportDonnees_libelleCompagnie_libelleEnvironnement`;
...
ALTER TABLE `tremas_compagnie_environnement`
ADD UNIQUE KEY `indImportDonnees_idCompagnie_idEnvironnement` (`idCompagnie`,`idEnvironnement`) USING BTREE,
ADD CONSTRAINT `compagnie_environnement_FKidCompagnie` FOREIGN KEY (`idCompagnie`) REFERENCES `tremas_compagnie` (`idCompagnie`) ON DELETE SET NULL ON UPDATE SET NULL,
ADD CONSTRAINT `compagnie_environnement_FKidEnvironnement` FOREIGN KEY (`idEnvironnement`) REFERENCES `tremas_environnement` (`idEnvironnement`) ON DELETE SET NULL ON UPDATE SET NULL;

UPDATE `tremas_compagnie_environnement` SET `idCompagnie`='1', `idEnvironnement`='2' WHERE (`idCompagnieEnvironnement`='1');
UPDATE `tremas_compagnie_environnement` SET `idCompagnie`='2', `idEnvironnement`='2' WHERE (`idCompagnieEnvironnement`='2');
UPDATE `tremas_compagnie_environnement` SET `idCompagnie`='1', `idEnvironnement`='1' WHERE (`idCompagnieEnvironnement`='3');
UPDATE `tremas_compagnie_environnement` SET `idCompagnie`='2', `idEnvironnement`='1' WHERE (`idCompagnieEnvironnement`='4');
