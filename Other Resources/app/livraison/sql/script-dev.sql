...
`idMotriceRefTosp`  int(11) NOT NULL AUTO_INCREMENT ,
...
`idMotriceRefOd`  int(11) NOT NULL AUTO_INCREMENT ,
`codeGareOrigineMotriceRefOd`  varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL ,
`codeGareDestinationMotriceRefOd`  varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL ,
`idCompagnie`  int(11) NOT NULL ,
PRIMARY KEY (`idMotriceRefOd`),
CONSTRAINT `ref_od_FKidCompagnie` FOREIGN KEY (`idCompagnie`) REFERENCES `tremas_compagnie` (`idCompagnie`) ON DELETE RESTRICT ON UPDATE RESTRICT,
UNIQUE INDEX `ref_od_UcodeGareOrigine_codeGareDestination_idCompagnie` (`codeGareOrigineMotriceRefOd`, `codeGareDestinationMotriceRefOd`, `idCompagnie`) 
)
;
...
ADD COLUMN `idCompagnie`  int(11) NOT NULL AFTER `labelCodeDiagramme`;
...
ADD COLUMN `idCompagnie`  int(11) NOT NULL AFTER `labelCompositionClass`;
...
ADD COLUMN `idCompagnie`  int(11) NOT NULL AFTER `labelDistribution`;
...
ADD COLUMN `idCompagnie`  int(11) NOT NULL AFTER `idMotriceRefEqpType`;
...
ADD COLUMN `idCompagnie`  int(11) NOT NULL AFTER `labelFareProfileCode`;
...
ADD COLUMN `idCompagnie`  int(11) NOT NULL AFTER `labelMealType`;
...
ALTER TABLE `tremas_motrice_ref_mealtype`
MODIFY COLUMN `labelMealType`  varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NULL AFTER `idMotriceRefMealType`,
...
ADD COLUMN `idCompagnie`  int(11) NOT NULL AFTER `labelRameCode`;
...
ADD COLUMN `idCompagnie`  int(11) NOT NULL AFTER `labelSatCode`;
...
ADD COLUMN `idCompagnie`  int(11) NOT NULL AFTER `labelService`;
...
ADD COLUMN `idCompagnie`  int(11) NOT NULL AFTER `libelleServiceClass`;
